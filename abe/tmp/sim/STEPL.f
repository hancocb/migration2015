! The program is written by Youn Shik Park (park397@purdue.edu, caronys@nate.com)
...
!----------------------------------------------E GW1 (LandRain_GW1.txt)---------
	...
	call ANRUNOFF(Rainfall,anDepth,feCN)
	call LANDRAIN
	call BMPS
	call ANIMAL
	call FEEDLOTS
...
!-------------------------------------------------------------------------------
!-------------------------------------------------------------------------------
	SUBROUTINE ANRUNOFF(Rainfall,anDepth,feCN)
