...
import cgi, cgitb, os, string, random, datetime, glob, math, locale, os.path
...
wsd = int(form.getvalue('Watershed'))
...
replaceFile = 'rm ./tmp/' + ystime + '/mlt/mainINP.txt'
replaceFile2 = 'mv ./tmp/' + ystime + '/mlt/mainINP' + str(wsd) + '.txt' + " ./tmp/" + ystime + '/mlt/mainINP.txt'
...
os.system(replaceFile)
os.system(replaceFile2)
...
print '<input type=submit style="width:150;height:30;cursor:hand" value="Optimize">'
